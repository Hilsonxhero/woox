            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                ...
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="{{asset('auth/assets/media/avatars/300-1.jpg')}}" alt="image"/>
                        <div
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">امیر</a>
                                <a href="#">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--end::Svg Icon-->
                                        <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="75">
                                            0
                                        </div>
                                    </div>
                                    <!--end::Number-->
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                       href="../../demo3/dist/account/overview.html">اطلاعات حساب کاربری</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                       href="../../demo3/dist/account/settings.html">تنطیمات</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                       href="../../demo3/dist/account/security.html">تنظیمات امنیتی</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                       href="../../demo3/dist/account/billing.html">اعلان ها</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                       href="../../demo3/dist/account/statements.html">پیام ها</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">اطلاعات حساب</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_account_profile_details_form" class="form">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-bold fs-6">پروفایل</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <!--begin::Image input-->
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px"
                                     style="background-image: url({{asset('auth/assets/media/avatars/300-1.jpg')}})"></div>
                            ...
                            <!--end::Image input-->
                            <!--begin::Hint-->
                            <div class="form-text">فایل های انتخابی : png, jpg, jpeg</div>
                            <!--end::Hint-->
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-bold fs-6">انتخاب شغل</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <!--begin::Input-->
                            <select name="language" aria-label="انتخاب شغل" data-control="select2"
                                    data-placeholder="انتخاب شغل"
                                    class="form-select form-select-solid form-select-lg">
                                <option value="">انتخاب شغل</option>
                                <option value="id">برنامه نویس
                                </option>
                                <option> فضانورد
                                </option>
                            </select>
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-bold fs-6">اعلان های دریافتی</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <!--begin::Options-->
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <label class="form-check form-check-inline form-check-solid me-5">
                                    ...
                                    <span class="fw-bold ps-2 fs-6">ایمیل</span>
                                </label>
                                <!--end::Option-->
                                <!--begin::Option-->
                                <label class="form-check form-check-inline form-check-solid">
                                    <input class="form-check-input" name="communication[]" type="checkbox" value="2"/>
                                    <span class="fw-bold ps-2 fs-6">تلفن همراه</span>
                                </label>
                                <!--end::Option-->
                            </div>
                            <!--end::Options-->
                    ...
                    <div class="row mb-0">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-bold fs-6">ارسال اعلان ها</label>
                        <!--begin::Label-->
                        <!--begin::Label-->
...
@section('js')
    ...
    <script src="{{asset('auth/assets/js/custom/account/settings/signin-methods.js')}}"></script>
    <script src="{{asset('auth/assets/js/custom/account/settings/profile-details.js')}}"></script>
    <script src="{{asset('auth/assets/js/custom/account/settings/deactivate-account.js')}}"></script>
@endsection
