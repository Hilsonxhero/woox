                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    ...
                    <div class="menu-sub menu-sub-accordion" kt-hidden-height="120"
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                            ...
                            <div class="menu-sub menu-sub-accordion" kt-hidden-height="78"
                                 style="display: none; overflow: hidden;">
                                <div class="menu-item">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/apps/user-management/users/view.html">
                                        ...
                                        <span class="menu-title">مشاهده کاربر</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="menu-sub menu-sub-accordion" kt-hidden-height="78"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/apps/user-management/roles/view.html">
                                        ...
                                        <span class="menu-title">مشاهده نقش کاربری</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link"
                               href="../../demo8/dist/authentication/extended/multi-steps-sign-up.html">
                                ...
                                <span class="menu-title">لیست مجوز ها</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link"
                               href="../../demo8/dist/authentication/extended/multi-steps-sign-up.html">
                                ...
                                <span class="menu-title">افزودن مجوز </span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link"
                               href="">
                                ...
                                <span class="menu-title">لیست  نقش های کاربری</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link"
                               href="">
                                ...
                                <span class="menu-title">افزودن  نقش  کاربری</span>
                            </a>
                        </div>
