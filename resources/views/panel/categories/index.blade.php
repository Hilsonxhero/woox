                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <!--begin::Type=-->
                            <td>
                                @if ($category->status == \App\Models\Category::PUBLISHED_STATUS)
                                    <div class="badge badge-light-success">{{ \App\Models\Category::PUBLISHED_STATUS }}
                                    </div>
                                @else
                                    <div class="badge badge-light-danger">{{ \App\Models\Category::UNPUBLISHED_STATUS }}
                                    </div>
                                @endif
