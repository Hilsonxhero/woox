            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                        class="form-control form-control-solid w-250px ps-14" placeholder="جستجوی کاربر" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_export_users_form" class="form"
                                    action="{{ route('admin.users.export.pdf') }}">

                                    <!--begin::Input group-->
                                    <div class="fv-row mb-10 d-none">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-bold form-label mb-2">انتخاب نقش کاربری</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="role" data-control="select2" data-placeholder="انتخاب نقش کاربری"
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-center min-w-125px">کاربر</th>
                        <th class="text-center min-w-125px">نقش کاربری</th>
                        <th class="text-center min-w-125px">شماره تلفن</th>
                        <th class="text-center min-w-125px">وضعیت</th>
                        <th class="text-center min-w-125px">تاریخ عضویت</th>
