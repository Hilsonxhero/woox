            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-center me-5 me-xxl-7 pt-2">
                        <div id="kt_card_widget_4_chart" style="min-width: 70px; min-height: 70px;direction: ltr" data-kt-size="70" data-kt-line="11"></div>
                    </div>
                    <!--end::Chart-->
                    <!--begin::Labels-->
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                ...
                <div class="card-body d-flex align-items-end px-0 pb-0">
                    <!--begin::Chart-->
                    <div id="kt_card_widget_6_chart" class="w-100" style="height: 80px;direction: rtl"></div>
                    <!--end::Chart-->
                </div>
                <!--end::Card body-->
            </div>
            ...
            <div class="card card-flush overflow-hidden h-md-100">
                ...
                <div class="card-header py-5">
                    ...
                    <div class="card-toolbar">
                        <a href="../../demo8/dist/apps/ecommerce/catalog/products.html" class="btn btn-sm btn-light-primary fw-bolder">Launch eCommerce App</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
                <!--end::Header-->
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    ...
                    <!--end::Statistics-->
                    <!--begin::Chart-->
                    <div id="kt_charts_widget_3" class="min-h-auto ps-4 pe-6" style="height: 300px;direction: ltr"></div>
                    <!--end::Chart-->
                </div>
                <!--end::Card body-->
            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
                                            <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
                                        </td>
                                        <td>
                                            <span class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">x1</span>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
        ...
        <div class="col-xl-6 mb-5 mb-xl-10">
            ...
            <div class="card card-flush overflow-hidden h-md-100">
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    ...
                    <!--end::Info-->
                    <!--begin::Chart-->
                    <div id="kt_charts_widget_4" class="min-h-auto ps-4 pe-6" style="height: 300px;direction: ltr"></div>
                    <!--end::Chart-->
                </div>
                <!--end::Card body-->
            </div>
            ...
            <div class="card h-md-100">
                ...
                <div class="card-body d-flex flex-column flex-center">
                    ...
                    <div class="text-center">
                        <!--begin::Link-->
                        <a class="btn btn-sm btn-primary me-2" href="../../demo8/dist/apps/ecommerce/sales/listing.html">View App</a>
                        <!--end::Link-->
                        <!--begin::Link-->
                        <a class="btn btn-sm btn-light" href="../../demo8/dist/apps/ecommerce/catalog/add-product.html">New Product</a>
                        <!--end::Link-->
                    </div>
                    <!--end::Links-->
                </div>
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-body">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#XGT-346</a>
                            </td>
                            <td class="text-end">31 December 2021, 3:13 pm</td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#YHD-047</a>
                            </td>
                            <td class="text-end">31 December 2021, 2:21 pm</td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SRR-678</a>
                            </td>
                            <td class="text-end">31 December 2021, 11:13 am</td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#PXF-534</a>
                            </td>
                            <td class="text-end">30 December 2021, 3:13 pm</td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#XGD-249</a>
                            </td>
                            <td class="text-end">29 December 2021, 3:13 pm</td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SKP-035</a>
                            </td>
                            <td class="text-end">28 December 2021, 3:13 pm</td>
                            <td class="text-end">
                                <a href="" class="text-dark text-hover-primary">Brian Cox</a>
                            </td>
                        ...
                        <tr>
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SKP-567</a>
                            </td>
                            <td class="text-end">25 December 2021, 3:13 pm</td>
                            <td class="text-end">
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    ...
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="btn btn-sm btn-light">Order Details</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
                <!--end::Header-->
                    ...
                    <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                        ...
                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">Elephant 1802</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Action-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <span class="text-gray-400 fw-bolder">To:
															<a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Jason Bourne</a></span>
                                <!--end::Name-->
                                <!--begin::Label-->
                        ...
                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">RiseUP</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Action-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Name-->
                                <span class="text-gray-400 fw-bolder">To:
															<a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Marie Durant</a></span>
                                <!--end::Name-->
                                <!--begin::Label-->
                        ...
                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">Yellow Stone</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Action-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Name-->
                                <span class="text-gray-400 fw-bolder">To:
															<a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Dan Wilson</a></span>
                                <!--end::Name-->
                                <!--begin::Label-->
                        ...
                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Name-->
                                <span class="text-gray-400 fw-bolder">To:
															<a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Lebron Wayde</a></span>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <span class="badge badge-light-success">Delivered</span>
                                <!--end::Label-->
                        ...
                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Name-->
                                <span class="text-gray-400 fw-bolder">To:
															<a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Ana Simmons</a></span>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <span class="badge badge-light-primary">Shipping</span>
                                <!--end::Label-->
                        ...
                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Name-->
                                <span class="text-gray-400 fw-bolder">To:
															<a href="../../demo8/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Kevin Leonard</a></span>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <span class="badge badge-light-danger">Confirmed</span>
                                <!--end::Label-->
                ...
                <div class="card-header pt-7">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-4">
                            ...
                            <!--end::Status-->
                            <!--begin::Search-->
                            <a href="../../demo8/dist/apps/ecommerce/catalog/products.html" class="btn btn-light btn-sm">View Stock</a>
                            <!--end::Search-->
                        </div>
                        <!--begin::Filters-->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">Macbook Air M1</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">Surface Laptop 4</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
                            ...
                            <!--end::Product ID-->
                            <!--begin::Date added-->
                            <td class="text-end">Feb 21, 2021</td>
                            <!--end::Date added-->
                            <!--begin::Price-->
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">Logitech MX 250</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">AudioEngine HD3</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">HP Hyper LTR</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">Dell 32 UltraSharp</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
                            <td class="text-end">#XGY-356</td>
                        ...
                        <tr>
                            <!--begin::Item-->
                            <td>
                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">Google Pixel 6 Pro</a>
                            </td>
                            <!--end::Item-->
                            <!--begin::Product ID-->
