...
@section('content')
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <ul class="navi navi-hover">
                                            <li class="navi-header pb-1">
                                                            <span
                                                                class="text-primary text-uppercase font-weight-bold font-size-sm">جدید اضافه کن:</span>
                                            </li>
                                            <li class="navi-item">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" x="3" y="13" width="3" height="7" rx="1.5"/>
                    ...
                    <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2"><!--begin::Svg Icon | path:assets/media/svg/icons/ارتباطات/Add-user.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero"/>
                    ...
                    <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2"><!--begin::Svg Icon | path:assets/media/svg/icons/desgin/Layers.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <polygon points="0 0 24 0 24 24 0 24"/>
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                    ...
                    <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2"><!--begin::Svg Icon | path:assets/media/svg/icons/ارتباطات/فوری-mail.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span
                                    class="text-muted mt-3 font-weight-bold font-size-sm">890,344 حراجی</span>
                            </h3>
                            <div class="card-toolbar">
                                <div class="dropdown dropdown-inline">
                                    <a href="#"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            <span class="symbol  symbol-50 symbol-light-primary mr-2">
                <span class="symbol-label">
                    <span class="svg-icon svg-icon-xl svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/ارتباطات/گروه.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <polygon points="0 0 24 0 24 24 0 24"/>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span
                                    class="text-muted mt-3 font-weight-bold font-size-sm">در انتظار 10 کار</span>
                            </h3>
                            <div class="card-toolbar">
        ...
        <rect fill="#000000" opacity="0.3"
              ...
              x="16.3255682" y="2.94551858" width="3" height="18" rx="1"/>
                                ...
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">گزارش
                                        پروژه</a>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                                ...
                                <!--begin::متن-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">طرح
                                        جامع</a>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                                ...
                                <!--begin::متن-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">منطق
                                        عملکردی</a>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                                ...
                                <!--begin::متن-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">آزمایش
                                        کردن</a>
                        ...
                        <div class="card-body pt-3 pb-0">
                            ...
                            <span class="text-muted font-weight-500">
                              جی اس,  جی اس
                                ...
                                <span class="svg-icon svg-icon-md svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/عمومی/تنظیمات-1.svg--><svg
                ...
                <span class="symbol-label">
                    <img src="assets/media/svg/avatars/009-boy-4.svg" class="h-75 align-self-end" alt=""/>
                                ...
                                <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">علیرضا
                                        مرادی</a>
            ...
            <span class="navi-text">
                ...
                <span class="symbol-label">
                    <img src="assets/media/svg/avatars/006-girl-3.svg" class="h-75 align-self-end" alt=""/>
                                ...
                                <!--begin::متن-->
                                <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">زینب
                                        غلامی</a>
                                    <span class="text-muted"> طراح دیتابیس</span>
                                </div>
                                <!--end::متن-->
            ...
            <span class="navi-text">
                ...
                <span class="symbol-label">
                    <img src="assets/media/svg/avatars/011-boy-5.svg" class="h-75 align-self-end" alt=""/>
                                ...
                                <!--begin::متن-->
                                <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">محمد
                                        زندی</a>
                                    <span class="text-muted"> طراح دیتابیس</span>
                                </div>
                                <!--end::متن-->
            ...
            <span class="navi-text">
                ...
                <span class="symbol-label">
                    <img src="assets/media/svg/avatars/016-boy-7.svg" class="h-75 align-self-end" alt=""/>
                                ...
                                <!--begin::متن-->
                                <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">علی
                                        جمشیدی</a>
                                    <span class="text-muted"> طراح دیتابیس</span>
                                </div>
                                <!--end::متن-->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 py-5">
                            ...
                            <div class="card-toolbar">
                                <a href="#" class="btn btn-info font-weight-bolder font-size-sm mr-3">گزارش
                                    جدید</a>
                                <a href="#" class="btn btn-danger font-weight-bolder font-size-sm">ایجاد
                                    کردن</a>
                            </div>
                        </div>
                        <!--end::Header-->
                                    ...
                                    <table
                                        ...
                                        <tr class="text-left text-uppercase">
                                            <th style="min-width: 250px" class="pl-7"><span
                                                    class="text-dark-75">محصولات</span></th>
                                                    ...
                                                    <div>
                                                        <a href="#"
                                                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">حسین
                                                            ذبیحی</a>
                                                        <span class="text-muted font-weight-bold d-block"> ری اکت جی اس</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                    ...
                                                    <div>
                                                        <a href="#"
                                                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">مینا
                                                            حسینی</a>
                                                        <span class="text-muted font-weight-bold d-block">سی شارپ</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                    ...
                                                    <div>
                                                        <a href="#"
                                                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">مریم
                                                            موسوی</a>
                                                        <span class="text-muted font-weight-bold d-block"> لاراول</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                    ...
                                                    <div>
                                                        <a href="#"
                                                           class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">بهناز
                                                            محمدزاده</a>
                                                        <span class="text-muted font-weight-bold d-block"> پی اچ پی</span>
                                                    </div>
                                                </div>
                                            </td>
